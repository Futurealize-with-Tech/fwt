...
export const courses = <CourseType[]>[
    ...
    {name: 'minecraft', nameText: 'マイクラ'},
    {name: 'eizou', nameText: '映像'},
    {name: 'animation', nameText: 'アニメーション'},
    {name: 'designer', nameText: 'デザイナー'},
    {name: 'mediaart', nameText: 'メディアアート'},
    {name: 'dtm', nameText: 'DTM'},
    {name: 'miku', nameText: '初音ミク'},
];
